...
class OAuthViewControllerTests: XCTestCase {
    ...
    func testRandomCode() {
        for i in 0...20 {
            ...
            let url = NSURL(string: "http://www.baidu.com/?code=\(democode)")!
    ...
    func testContiuneWithCode() {
        ...
        2. code 的条件，返回的地址是预先设定的
            回调地址 http://www.baidu.com 同样不需要加载
        ...
        */
        ...
        // 登录界面的 URL
        // 应该加载，没有 code
        var url = NSURL(string: "https://api.weibo.com/oauth2/authorize?client_id=2720451414&redirect_uri=http://www.baidu.com")!
        ...
        // 点击注册按钮
        // 不加载，没有code
        url = NSURL(string: "http://weibo.cn/dpool/ttt/h5/reg.php?wm=4406&appsrc=4o1TqS&backURL=https%3A%2F%2Fapi.weibo.com%2F2%2Foauth2%2Fauthorize%3Fclient_id%3D2720451414%26response_type%3Dcode%26display%3Dmobile%26redirect_uri%3Dhttp%253A%252F%252Fwww.baidu.com%26from%3D%26with_cookie%3D")!
        ...
        url = NSURL(string: "http://www.baidu.com/?code=\(democode)")!
        result = oauthVC!.continueWithCode(url)
        XCTAssertFalse(result.load, "不应该加载")
        XCTAssert(result.code == democode, "code 不正确")
        ...
        // 切换账号
        url = NSURL(string: "http://login.sina.com.cn/sso/logout.php?entry=openapi&r=https%3A%2F%2Fapi.weibo.com%2Foauth2%2Fauthorize%3Fclient_id%3D2720451414%26redirect_uri%3Dhttp%3A%2F%2Fwww.baidu.com")!
        result = oauthVC!.continueWithCode(url)
        XCTAssertFalse(result.load, "不应该加载")
        XCTAssertNil(result.code, "不应该有code")
    }
